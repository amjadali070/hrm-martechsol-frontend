...
import { FaDownload, FaFileAlt, FaQuestionCircle } from 'react-icons/fa';
...
const PolicyInfoModal: React.FC<PolicyInfoModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-xl p-6 max-w-md w-full relative">
        ...
        <h3 className="text-xl font-bold mb-4 text-purple-900">Policy Information</h3>
        ...
        <div className="p-6 md:p-10 relative">
          ...
          <div className="mt-8 text-center bg-blue-50 p-4 rounded-xl">
            <p className="text-sm text-gray-700 leading-relaxed">
              ...
              <span className="font-bold text-purple-700">HR Support</span> 
