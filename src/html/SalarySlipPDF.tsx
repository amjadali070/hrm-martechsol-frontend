      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTop}>
            ...
            <Text style={styles.brandName}>www.nexus.com</Text>
          </View>
          ...
          <View style={styles.finTable}>
            ...
            <View style={styles.finColumn}>
              ...
              <View style={[styles.totalRow, styles.earningTotal]}>
                ...
                <Text style={styles.totalValueEarnings}>
            ...
            <View style={styles.finColumn}>
              ...
              <View style={styles.finRow}>
                ...
                <Text style={[styles.finValue, { color: colors.rose600 }]}>
              ...
              <View style={[styles.totalRow, styles.deductionTotal]}>
                ...
                <Text style={styles.totalValueDeductions}>
