...
import { FaEdit, FaInbox, FaSpinner, FaTrash, FaBullhorn, FaPlus, FaFilter, FaCheckDouble, FaEnvelopeOpenText, FaEnvelope } from "react-icons/fa";
       ...
       <div className="p-8">
          ...
          {filteredNotices.length === 0 ? (
            <div className="text-center py-20 bg-alabaster-grey-50/50 rounded-xl border border-dashed border-platinum-200">
                ...
                <h3 className="text-lg font-bold text-gunmetal-900">No notices found</h3>
                 <p className="text-slate-grey-500 text-sm mt-1">Try changing the filters or create a new notice.</p>
            </div>
          ) : (
            <>
               <div className="overflow-x-auto rounded-xl border border-platinum-200 shadow-sm">
                 <table className="w-full text-left bg-white border-collapse">
                   <thead className="bg-alabaster-grey-50">
                     <tr>
                        <th className="py-4 px-6 text-xs font-bold text-slate-grey-500 uppercase tracking-wider border-b border-platinum-200 w-16 text-center">No.</th>
                        <th className="py-4 px-6 text-xs font-bold text-slate-grey-500 uppercase tracking-wider border-b border-platinum-200">Date</th>
                        <th className="py-4 px-6 text-xs font-bold text-slate-grey-500 uppercase tracking-wider border-b border-platinum-200 w-1/3">Subject</th>
                        <th className="py-4 px-6 text-xs font-bold text-slate-grey-500 uppercase tracking-wider border-b border-platinum-200 text-center">Status</th>
                        <th className="py-4 px-6 text-xs font-bold text-slate-grey-500 uppercase tracking-wider border-b border-platinum-200 text-end">Actions</th>
                     </tr>
                   </thead>
                         ...
                         <td className="py-4 px-6 text-center">
                            <div className="flex items-center justify-center gap-2">
                                ...
                                <button
                                    ...
                                    title={notice.status === 'Read' ? "Mark as Unread" : "Mark as Read"}
                                >
                                    {notice.status === "Read" ? (
                ...
                <form onSubmit={handleNoticeSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         <div className="space-y-2">
                            <label className="text-sm font-semibold text-gunmetal-700">Subject</label>
                            <input
                                type="text"
                        ...
                        <div className="space-y-2">
                             <label className="text-sm font-semibold text-gunmetal-700">Date</label>
                             <input
                                type="date"
                    ...
                    <div className="space-y-2">
                         <label className="text-sm font-semibold text-gunmetal-700">Message Content</label>
