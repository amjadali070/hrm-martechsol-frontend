  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
        ...
        <h1 className="text-xl font-semibold text-gray-800">Preparing Your Experience Letter...</h1>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="text-black py-6">
        <h1 className="text-2xl md:text-3xl font-bold text-center mt-2 text-black">Experience Letter</h1>
      </header>
