          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              {isEditing ? (
                ...
                <p className="text-gray-700 font-semibold">{registrationNo}</p>
              )}
            </div>
          </div>
              ...
              {preview ? (
                <div className="relative group h-40 w-full flex justify-center items-center overflow-hidden ">
                  <img
                    src={preview}
                    alt="Vehicle"
                    className="h-40 bject-contain rounded-lg"
                  />
                  {isEditing && (
                    <button
                      type="button"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {vehicle.vehicleDocuments.map((doc, idx) => (
                    ...
                    >
                      ...
                      <a
                        href={`${(axiosInstance.defaults.baseURL ?? "").replace(
                          "/api",
                          ""
                        )}/${doc}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-blue-700 hover:underline text-sm truncate flex-1"
                      >
                        {`Document ${idx + 1}`}
                      </a>
                    </div>
