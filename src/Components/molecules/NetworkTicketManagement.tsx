...
const NetworkTicketManagement: React.FC = () => {
  ...
  const StatusBadge = ({ status }: { status: string }) => {
     const styles = {
      ...
      Open: "bg-orange-50 text-orange-600 border-orange-100", // Using Orange for Network Tasks
    };
    const icons = {
    ...
    <div className="bg-white rounded-2xl shadow-xl border border-platinum-200 overflow-hidden">
      <div className="p-6 border-b border-platinum-200 bg-white flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-grey-500">Resolve connectivity and hardware issues</p>
          </div>
              ...
              <tr>
                <td colSpan={7} className="text-center py-16">
                   <div className="flex flex-col items-center justify-center animate-pulse">
                     ...
                     <span className="text-slate-grey-500 font-medium">Loading Network tickets...</span>
                   </div>
                </td>
              </tr>
            ) : notFound ? (
                ...
                <td colSpan={7} className="text-center py-16">
                  <div className="flex flex-col items-center justify-center">
                    <div className="w-16 h-16 bg-alabaster-grey-50 rounded-full flex items-center justify-center mb-4 border border-platinum-200">
                         <FaNetworkWired className="text-slate-grey-400 text-2xl" />
                    </div>
