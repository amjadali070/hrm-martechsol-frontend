...
const RecentFiles: React.FC = () => {
  return (
    <div className="flex overflow-hidden flex-col justify-center px-1.5 py-1 mt-6 w-full text-lg font-medium bg-blue-50 rounded-md border border-solid border-slate-300 text-stone-900 max-md:max-w-full">
