         ...
         <div className="p-8">
            <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                     ...
                     <div>
                        <h2 className="text-xl font-bold text-gunmetal-900">Process Payroll</h2>
                        <p className="text-xs text-slate-grey-500">Finalize and lock payroll for payment</p>
                     </div>
                </div>
                <button
                    onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                 <div>
                    ...
                    <select
                        ...
                        className="w-full px-4 py-3 bg-alabaster-grey-50 border border-platinum-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all cursor-pointer text-gunmetal-900 font-medium appearance-none"
                    >
                 ...
                 <div>
                    ...
                    <input
                        ...
                        min={2000}
                        max={2100}
                        className="w-full px-4 py-3 bg-alabaster-grey-50 border border-platinum-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all text-gunmetal-900 font-medium"
                    />
                 </div>
