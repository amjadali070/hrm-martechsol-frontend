// src/Components/organisms/SignInPage.tsx
...
const SignInPage: React.FC = () => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const profileResponse = await axios.get('/api/users/profile', { withCredentials: true });
  ...
  return (
    ...
    </main><ToastContainer position="top-center" /></>
  );
};
